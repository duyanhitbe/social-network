import { Body, ConflictException, Controller, ForbiddenException, Post, Res } from '@nestjs/common';
...
export class AuthController {
	...
	@Post('login')
	async login(@Res({ passthrough: true }) response: Response, @Body() data: LoginUserDto) {
